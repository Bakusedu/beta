                                   ...
                                   <?php if($priviledges == 1): ?>
                                      <li><a><i class="fa fa-table"></i>Register Courses<span class="fa fa-chevron-down"></span></a>
                                        ...
                                        <li><a href="register_courses.php">1st Semester</a></li>
                                          <!-- <li><a href="y1_2ndsemester.php">2nd Semester</a></li>   Note *Check back to always configure the semester* -->
                                        </li>
                                     ...
                                     <?php else: ?>
                                       ...
                                       <?php if($result): ?>
                                         ...
                                         <li><a href='view_registered.php?id=<?php echo $res['id']; ?>'><?php echo $res['name']; ?></a><span class="badge"><?php $count = $lecturer->count($res['id'],$_SESSION['us3rid']);if(count($count) > 1){
                                           echo(count($count));
                                         }
                                         else{
                                           echo "0";
                                ...
                                <li><a><i class="fa fa-book"></i> Results <span class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu" style="display: none">
                                      <?php if($priviledges == 2): ?>
                                        ...
                                        <li class="current-page"><a href="year1result.php">Examination</a>
                                        </li>
                                      <?php endif; ?>
