...
<?php
  ...
  if(isset($_POST['update'])){
    ...
    if($admin->department == '--Choose--'){
      $errors[] = "Department field empty";
    }
    ...
    if($file['error'] == 4){
      if(empty($errors)){
         $result = $admin->updateLecturer();
        if($result){
          $session->message('Account updated successfully');
          redirectTo('lecturer_view.php');
         }
      }
    }
    else{
      ...
      <div class="col-md-12">
        <div class="row">
          <div class="col-md-8">
            ...
            <form action="lecturer_update.php?id=<?php echo $id; ?>" method="post" enctype="multipart/form-data">
              <fieldset>
                <?php $pic = $admin->getLPicture($id); ?>
                <?php $info = $admin->getLecturerInfo($id); ?>
                <h4>Update lecturer profile</h4>
                <div class="row">
          ...
          <div class="col-md-3">
            <div class="panel panel-primary">
              <ul class="list-group">
                <li class="list-group-item"><a href="lecturer_list.php"><i class="fa fa-user"></i> Lecturer profile</a></li>
