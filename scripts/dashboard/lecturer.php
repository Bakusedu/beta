...
<?php
  ...
  if(isset($_POST['regista'])){
    ...
    if(empty($errors)){
      $result = $admin->create();
      $create = $admin->createLecturerInfo($result);
      if($create){
        ...
        <div class="row">
          <div class="col-md-8">
            ...
            <form action="lecturer.php" method="post">
              <h2><i class="fa fa-plus"></i>Add new lecturer</h2>
              <fieldset>
                <legend>Lecturer profile</legend>
                ...
                <legend>Lecturer credentials</legend>
                <div class="form-group">
                  <label for="name">Full name</label>
                  <input type="text" class="form-control" name="name" placeholder="Lecturer name" value="">
                </div>
                <div class="form-group">
          ...
          <div class="col-md-3">
            <div class="panel panel-primary">
              <ul class="list-group">
                <li class="list-group-item"><a href="lecturer_profile.php"><i class="fa fa-user"></i> Lecturer profile</a></li>
