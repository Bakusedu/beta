       ...
       <?php if($results):?>
         <div class="container">
           <div class="row">
             <div class="col-md-12">
               <div class="col-md-5">
                 <h3><strong><?php echo $res['name'] ?></strong> Student Assessment</h3>
           ...
           <div class="col-md-12">
             <div class="panel panel-primary">
               <ul class="list-group">
                 <li class="list-group-item text-center"><a href="course_examination.php?id=<?php echo $_SESSION['courseid'] ?>"><i class="fa fa-user"></i> <strong><?php echo $res['name']?></strong> Examination</a></li>
        ...
        <div class="col-md-12 table-responsive">
          ...
          <tbody>
              ...
              <tr>
                ...
                <?php if($true): ?>
                  <td><a class="btn btn-success" href="assessment_processing.php?id=<?php echo $result['studentid']?>">Update</a></td>
              <?php else: ?>
                <td><a class="btn btn-success" href="assessment_processing.php?id=<?php echo $result['studentid']?>">Enter</a></td>
              <?php endif; ?>
                <?php $i = $i + 1;?>
                <!-- <td></td> -->
              </tr>
