       ...
       <?php if($results):?>
         <div class="container">
           <div class="row">
             <div class="col-md-12">
               <div class="col-md-5">
                 <h3><strong><?php echo $res['name'] ?></strong> Student Results</h3>
           ...
           <div class="col-md-12">
             <div class="panel panel-primary">
               <ul class="list-group">
                 ...
                 <li class="list-group-item text-center"><a href="course_examination.php?id=<?php echo $_SESSION['courseid'] ?>"><i class="fa fa-graduation-cap"></i> <strong><?php echo $res['name'] ?></strong> Examination</a></li>
               </ul>
             </div>
           </div>
         </div>
              ...
              <tr>
                ...
                <?php if($true): ?>
                  <?php if($update['exam_score'] == NULL): ?>
                    <td><a class="btn btn-success" href="result_processing.php?id=<?php echo $result['studentid']?>">Grade</a><span class="alert alert-danger">No Exam Score</span></td>
                <?php else: ?>
                  <?php $grade = $lecturer->checkGrade($result['studentid'],$_SESSION['courseid']); ?>
                    <?php if($grade['grade'] == NULL): ?>
                      <td><a class="btn btn-success" href="result_processing.php?id=<?php echo $result['studentid']?> ">Grade</a></td>
                    <?php else: ?>
                      <td><a class="btn btn-success" href="result_processing.php?id=<?php echo $result['studentid']?>">Upload</a></td>
                    <?php endif; ?>
                <?php endif; ?>
              <?php else: ?>
                <td><a class="btn btn-success" href="result_processing.php?id=<?php echo $result['studentid']?>">Grade</a><span class=".small text-danger"> No assessment</span></td>
              <?php endif; ?>
                <?php $i = $i + 1;?>
                <!-- <td></td> -->
              </tr>
